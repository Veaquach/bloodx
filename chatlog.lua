...
local theme = {
    ...
    Secondary = Color3.fromRGB(110, 45, 45),
    Command = Color3.fromRGB(150, 25, 25),
}
...
title.Parent = fr
title.Text = "Logging With BloodX"
...
title.TextColor3 = Color3.fromRGB(150, 25, 25)
...
grad4.Color = ColorSequence.new({
    ...
    ColorSequenceKeypoint.new(1, Color3.fromRGB(175, 0, 0)),
})
...
scrollfr.ScrollBarImageColor3 = Color3.fromRGB(255, 0, 0)
...
function addlog(player, text, issys)
    ...
    elseif isme then
        ...
        textgrad.Color = ColorSequence.new({
            ColorSequenceKeypoint.new(0, Color3.fromRGB(255, 0, 0)),
            ColorSequenceKeypoint.new(0.5, Color3.fromRGB(155, 0, 0)),
            ColorSequenceKeypoint.new(1, Color3.fromRGB(175, 0, 0)),
        })
        textgrad.Parent = label
    end
